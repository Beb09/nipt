...
<div class="wrapper">
          ...
          <form method="post" id="signup-user" action="adduser.php" enctype="multipart/form-data">
            <div class="col-md-6 col-md-offset-3">
              ...
              if(isset($_SESSION['registerError'])) {
                ?>
                <div class="form-group">
                  <label style="color: red;">Email Already Exists! Please Choose A Different Email!</label>
                </div>
              <?php
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2023 <a href="#"> National Institute of Professional Training </a>.</strong> All rights reserved.  
    </div>
  </footer>
